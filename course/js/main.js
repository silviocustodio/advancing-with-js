...
//===================== validation  desc, amount and value ===============================================
...
function validation() {
    ...
    if (errors !=""){
        ...
        document.getElementById("errors").style.backgroundColor = "rgba(183, 178, 178, 0.5)";
...
//===================== save list in local storage browser ===============================================
...
function initListStorage() {
    ...
    var testList = localStorage.getItem("list");// check if list is saved in local storage
    if(testList){
        list = JSON.parse(testList); //if list is valid, get attribute to list the array, recovery list
    }
    setList(list);
}
